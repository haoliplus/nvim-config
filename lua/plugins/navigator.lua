return {
  ...
  { -- fuzzy search using telescope
    ...
    keys = {
      ...
      { "<Leader>fr", "<cmd>Telescope oldfiles<cr>", mode = "n", desc = "old files" },
      ...
      { "<Leader>ft", "<cmd>Telescope tags<cr>", mode = "n", desc = "tags" },
      { "<c-f>", "<cmd>Telescope find_files<cr>", mode = "n", desc = "find files" },
    },
  },
  { -- add bookmarks
