return {
  ...
  },
  {
    ...
    keys = {
      ...
      { "<leader>B", ":Neotree buffers<CR>", desc = "Explorer Buffers (root dir)", remap = true },
      -- { "<leader>G", ":Neotree toggle float git_status<CR>", desc = "Explorer NeoTree (cwd)", remap = true },
      { "<leader>G", ":Neotree git_status<CR>", desc = "Explorer NeoTree (cwd)", remap = true },
